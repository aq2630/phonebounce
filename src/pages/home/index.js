...
import callBlocking from '../../assets/images/14_Call_Blocking-100px.png'
import callForwarding from '../../assets/images/15_Call_Forwarding-100px.png'
...
return (
    ...
    <div className="container">
        <div className="row">
            <div className="col-md-4 col-sm-12 services-items">
            <svg className="mb-3" xmlns="http://www.w3.org/2000/svg" version="1.1" width="50" height="50" viewBox="0 0 32 32" class="svg" src="fonts/svg/mobile.svg" alt="mobile">
            <title>mobile</title>
            ...
            <div className="col-md-4 services-items mx-3">
            <svg className="mb-3" xmlns="http://www.w3.org/2000/svg" version="1.1" width="50" height="50" viewBox="0 0 32 32" class="svg" src="fonts/svg/phone.svg" alt="phone">
            <title>phone</title>
            ...
            <div className="col-md-4 services-items">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="50" height="50" viewBox="0 0 32 32" class="svg" src="fonts/svg/global.svg" alt="global">
            <title>global</title>
...
Sign up today for free and have the first calls on us.</p> 
            ...
            <Grid conatiner spacing={1}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} md={6} lg={6}>
                        <FeatureItem image={callBlocking} imageAlt="Call Blocking" title="Call Blocking" />
                    </Grid>
                    <Grid item xs={12} md={6} lg={6}>
                            <FeatureItem image={callForwarding} imageAlt="Call Forwarding" title="Call Forwarding" />
                    </Grid>
                </Grid>
                <Grid container spacing={2}>
                    <Grid item xs={12} md={6} lg={6}>
    ...
    <Box className="review-section py-3 px-5" >
    ...
    <Box className="contact_services py-5 px-5">
        <Container>
            <Grid container spacing={2}>
