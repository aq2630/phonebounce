...
return (
    ...
    <div><Box className="bg-main py-5 px-5">
    <Container > 
    ...
    <Box className="bg-what-we-do px-5 py-5">
        <Container className="what-we-do-box">
            <Grid container spacing={2}>
                ...
                <Grid item xs={6} className="my-5 px-5">
                    <h4>How We Do It?</h4>
                ...
                <Grid item xs={6} className="my-5 px-5">
                    <img src={PhoneBounceIn} alt="PhonceBounce In"/>
                </Grid>
                <Grid item xs={6} className="my-5 px-5">
                <img src={PhoneBounceOut} alt="PhonceBounce Out"/>
                </Grid>
                <Grid item xs={6} className="my-5 px-5">
    ...
    <Box className="maping py-4 px-5">
        <Container>
